  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <AreaChart data={data} margin={{ top: 5, right: 4, left: 0, bottom: 0 }}>
        ...
        <Area type="monotone" dataKey="collected" name="Collected"       stroke="#0066ff" fill="url(#collectedGrad)" strokeWidth={2.5} dot={false} activeDot={{ r: 4, fill: "#0066ff" }} />
        <Area type="monotone" dataKey="expenses"  name="Operating Costs" stroke="#f43f5e" fill="url(#expenseGrad)"   strokeWidth={2}   dot={false} activeDot={{ r: 4, fill: "#f43f5e" }} />
      </AreaChart>
    </ResponsiveContainer>
  );
}
